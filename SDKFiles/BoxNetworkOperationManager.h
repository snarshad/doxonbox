...
typedef void(^BoxOperationCompletionHandler)(BoxOperation *op, BoxOperationResponse response);
typedef void(^BoxGetFolderCompletionHandler)(BoxFolder* folder, BoxFolderDownloadResponseType response);

@interface BoxNetworkOperationManager : NSObject
